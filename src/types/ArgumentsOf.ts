...
import type { Attachment, Channel, Collection, GuildChannel, GuildMember, Role, Message, User } from "discord.js";
...
type TypeIdToType<T, O, C, P> = T extends ApplicationCommandOptionType.Subcommand
	...
	? P extends Runtime.Discordjs
		...
		: APIRole | { member?: APIGuildMember & { permissions: Permissions }; user: APIUser } | undefined
...
> = C extends {
	...
	? P extends Runtime.Discordjs
		...
		: { user: { member?: APIGuildMember & { permissions: Permissions }; user: APIUser } }
