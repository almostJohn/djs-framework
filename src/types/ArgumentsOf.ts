...
type ArgumentsOfRaw<O, P, R extends CacheType = "cached"> = O extends readonly any[]
	? UnionToIntersection<OptionToObject<O[number], P, R>>
	: never;
...
> = C extends {
	...
	? P extends Runtime.Discordjs
		? {
				members: Collection<
					Snowflake,
					CacheTypeReducer<T, GuildMember, APIGuildMember, APIGuildMember | GuildMember, APIGuildMember | GuildMember>
				>;
