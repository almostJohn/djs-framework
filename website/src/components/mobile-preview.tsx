...
const TEMPLATE_CLIENT = `createClient({ intents: [GatewayIntentBits.Guilds, GatewayIntentBits.GuildMessages] });`;
const TEMPLATE_DOCS = "// instantiate commands";

export function MobilePreview() {
	return (
		<section className="overflow-y-auto px-4 py-2 rounded-lg border bg-muted shadow-md md:hidden">
			<div className={cn("flex flex-col space-y-4", jetBrainsMono.className)}>
				<p className="text-xs">
